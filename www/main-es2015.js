...
/* harmony import */ var ngx_pinch_zoom__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ngx-pinch-zoom */ "./node_modules/ngx-pinch-zoom/fesm2015/ngx-pinch-zoom.js");
...
let NavigationComponent = class NavigationComponent {
    constructor(router, storage, menuCtrl, geolocation, nativeGeocoder, androidPermissions, locationAccuracy) {
        this.router = router;
        this.storage = storage;
    ...
    getCurrentLocation() {
        this.geolocation.getCurrentPosition().then((resp) => {
            ...
            this.nativeGeocoder.reverseGeocode(resp.coords.latitude, resp.coords.longitude, options)
                ...
                this.currentAddress += result[0].areasOfInterest[0] + ', ' + result[0].subLocality + ', ' + result[0].locality + ', ' + result[0].subAdministrativeArea + ', ' + result[0].administrativeArea + ', ' + result[0].postalCode + ', ' + result[0].countryName + '.';
...
let ProductDetailsComponent = class ProductDetailsComponent {
    constructor(storage, router, route, _ProductsService) {
        this.storage = storage;
        this.router = router;
        this.route = route;
...
let SeparetSectionComponent = class SeparetSectionComponent {
    constructor(storage, router, route, _ProductsService) {
        this.storage = storage;
        this.router = router;
        this.route = route;
...
SeparetSectionComponent.ctorParameters = () => [
    { type: _ionic_storage__WEBPACK_IMPORTED_MODULE_2__["Storage"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] },
    { type: _services_products_service__WEBPACK_IMPORTED_MODULE_4__["ProductsService"] }
...
/* harmony import */ var ngx_filter_pipe__WEBPACK_IMPORTED_MODULE_43__ = __webpack_require__(/*! ngx-filter-pipe */ "./node_modules/ngx-filter-pipe/esm2015/ngx-filter-pipe.js");
...
let ProductsService = class ProductsService {
    ...
    getProductDetails(id, container) {
        return eval('this.' + container + '[' + id + ']');
    }
    getProductsList(container) {
